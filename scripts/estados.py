...
gdf["id"] = gdf["id"].apply(lambda x: unidecode(x.upper()))

# Lista de estados a destacar
good = {"2611606","2927408","3304557","MG"}
bad = {"3205309", "2507507", "AP"}
...
plt.savefig("brasil_estados.png", dpi=300, bbox_inches="tight")
plt.show()